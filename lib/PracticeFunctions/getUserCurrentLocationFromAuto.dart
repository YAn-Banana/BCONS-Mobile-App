import 'package:bcons_app/PracticeFunctions/TypeOfReport/automated_report_with_confirmation.dart';
...
class UserCurrentLocationAuto extends StatefulWidget {
  const UserCurrentLocationAuto({Key? key}) : super(key: key);

  @override
  State<UserCurrentLocationAuto> createState() =>
      _UserCurrentLocationAutoState();
}

class _UserCurrentLocationAutoState extends State<UserCurrentLocationAuto> {
  String location = '';
  String latitude = '';
  String longitude = '';
  String locality = '';
                  ...
                  ? () {
                      ...
                      try {
                        ...
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const AutomatedReport()));
                      } catch (e) {
