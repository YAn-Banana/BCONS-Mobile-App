                    ...
                    children: [
                      ...
                      const Text('Definitions and Key Terms',
                          style: TextStyle(
                              ...
                              fontFamily: 'PoppinsBold',
                              letterSpacing: 2.0)),
                      const Text('For this Terms & Conditions: ',
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 17.0,
                              fontFamily: 'PoppinsRegular',
                      ...
                      const Text(
                          'Bulacan Collaborative Network for Safety(BCONS)\'s site, which can be accessed via this URL: ___________',
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 17.0,
                              fontFamily: 'PoppinsRegular',
                      ...
                      const Text('Return and Refund Policy',
                          style: TextStyle(
                              color: Color(0xffd90824),
                              fontSize: 30.0,
                              fontFamily: 'PoppinsBold',
                      ...
                      const Text('Changes to other Terms and Conditions',
                          style: TextStyle(
                              color: Color(0xffd90824),
                              fontSize: 30.0,
                              fontFamily: 'PoppinsBold',
                      ...
                      const Text('Modifications to our Service',
                          style: TextStyle(
                              color: Color(0xffd90824),
                              fontSize: 30.0,
                              fontFamily: 'PoppinsBold',
                      ...
                      const Text('Updates to Our service',
                          style: TextStyle(
                              color: Color(0xffd90824),
                              fontSize: 30.0,
                              fontFamily: 'PoppinsBold',
                      ...
                      const Text('Copyright and Infringement Notice',
                          style: TextStyle(
                              color: Color(0xffd90824),
                              fontSize: 30.0,
                              fontFamily: 'PoppinsBold',
                      ...
                      const Text('Update to our Terms',
                          style: TextStyle(
                              color: Color(0xffd90824),
                              fontSize: 30.0,
                              fontFamily: 'PoppinsBold',
                      ...
                      const Text('Agreement to Arbitrate',
                          style: TextStyle(
                              color: Color(0xffd90824),
                              fontSize: 30.0,
                              fontFamily: 'PoppinsBold',
                              letterSpacing: 2.0)),
                      const Text(
                          'This section applies to any dispute EXCEPT IT DOESN\'T INCLUDE A DISPUTE RELATING TO CLAIMS FOR INJUNCTIVE OR EQUITABLE RELIEF REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Bulacan Collaborative Network for Safety(BCONS)\'s INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute, action, or other controversy between you and us concerning the Services or this agreement, whether in contract, warranty, tort, statute, regulation, ordinance, or any other legal or equitable basis. “Dispute” will be given the broadest possible meaning allowable under law.',
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 17.0,
                              fontFamily: 'PoppinsRegular',
                      ...
                      const Text('Submissions and Privacy',
                          style: TextStyle(
                              color: Color(0xffd90824),
                              fontSize: 30.0,
                              fontFamily: 'PoppinsBold',
                      ...
                      const Text('Typographical Error',
                          style: TextStyle(
                              color: Color(0xffd90824),
                              fontSize: 30.0,
                              fontFamily: 'PoppinsBold',
                      ...
                      const Text('Via Email: bcons2122@gmail.com',
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 17.0,
                              fontFamily: 'PoppinsRegular',
